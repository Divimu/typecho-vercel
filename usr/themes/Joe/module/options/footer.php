...
$JFooterTabbar = new \Typecho\Widget\Helper\Form\Element\Textarea(
	...
	NULL,
	'移动端底部Tab导航',
	'介绍：在移动端固定显示在最底部的tab导航按钮，支持排序和添加删除，注意开启后按钮不宜过多 | <a target="_blank" href="https://blog.yihang.info/archives/232.html">查看官网教程</a>'
);
...
if (empty(\Helper::options()->JFooterMode) || \Helper::options()->JFooterMode == 'simple') {
	$JFooter_Left_Value = '2024 - ' . date('Y') . ' © <a href="https://' . JOE_DOMAIN . '">' . Helper::options()->title . '</a>丨技术支持：<a href="https://www.moxen.cn" target="_blank">墨尘</a>';
	...
	$JFooter_Right_Value = '<a href="https://beian.miit.gov.cn/#/Integrated/index" target="_blank">蜀ICP备2024092286号</a>';
...
if (empty(\Helper::options()->JFooterMode) || \Helper::options()->JFooterMode == 'commercial') {
	...
	$JFooterCenter2Value = '<a href="https://beian.miit.gov.cn/" class="icp" target="_blank" rel="nofollow">蜀ICP备2024092286号</a>||<br>||Copyright © 2024 - ' . date('Y') . ' · <a href="https://' . JOE_DOMAIN . '">' . Helper::options()->title . '</a>||<br>||技术支持：<a href="https://www.moxen.cn" target="_blank">墨尘</a>';
